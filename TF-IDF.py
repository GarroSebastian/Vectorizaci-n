...
input_file_path = r'C:\Universidad\2024-1\Seminario 1\Vectorización\textos_procesados_con_sentimiento.csv'
output_file_path = r'C:\Universidad\2024-1\Seminario 1\Vectorización\textos_vectorizados_tfidf.csv'
